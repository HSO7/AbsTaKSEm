...
install() {
reset
echo -e "\e[38;5;77m • Welcome to Source TaKSEm - اهلا بك في سورس تقسيم •\e[0m"
echo -e "\e[38;5;77m      •{ Setting up offices - جاري رفع المكاتب } •\e[0m"
echo -e "\e[38;5;77m • Installing Source TaKSEm - جاري تحميل سورس تقسيم •\e[0m"
